# Building Shopify Apps Using PHP
...
Exact parameters are in the **OAuth usage docs** (signatures and required request/cookie plumbing). If you’d like, I can drop in those two route handlers next. ([GitHub][3])
